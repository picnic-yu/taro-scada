...
export default class Mine extends Component {
    ...
    componentDidMount(){
        ...
        // 高压设备分页
        api.get('api/services/app/HighVoltageInformation/GetPaged',{BoxTransformerOrPowerDistributionRoomId,BelongType:1}).then((res)=>{
            if(res.data.success){
        ...
        // 低压设备分页
        api.get('api/services/app/LowVoltageInformation/GetPaged',{BoxTransformerOrPowerDistributionRoomId,BelongType:1}).then((res)=>{
            if(res.data.success){
        ...
        api.get('api/services/app/TransformerInformation/GetPaged',{BoxTransformerOrPowerDistributionRoomId,BelongType:1}).then((res)=>{
            if(res.data.success){
